...
RULES = [
    ...
    ("banned-word", "warning", r"\bsanity[- ]check\b", "Use final check or quick check.", CI, False),
    ...
    ("banned-word", "warning", r"\ballows you to\b", "Use lets you.", CI, False),
    ...
    ("banned-word", "warning", r"\bhit\s+(?!rate|count|ratio|percentage)", "Use click, press, or tap.", CI, False),
    ...
    ("condescending", "warning", r"\b([Ee]asy|[Ee]asily|[Ss]imply|simple|[Oo]bvious(ly)?|[Tt]rivial(ly)?|of course)\b",
     "Condescending. Delete, or state the actual steps.", 0, False),
